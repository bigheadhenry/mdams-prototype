...
- `01-总览/DOCUMENTATION_UPDATE_PLAN.md`

## 目录结构

- `01-总览/`
  项目状态、计划、验收、测试策略、工作日志、文档更新方案
- `02-架构设计/`
  系统架构、平台适配器、API 路由、认证与 IIIF、三维子系统
- `03-产品与流程/`
  角色权限、菜单矩阵、工作流、图像记录工作台说明
- `04-实施方案/`
  各阶段实施基线与归档方案
- `05-部署与运维/`
  部署、环境变量、排障、脚本与批处理说明
...
3. `03-产品与流程/USER_ROLE_PERMISSION_MATRIX.md`
4. `03-产品与流程/WORKFLOW_GUIDE.md`
5. `02-架构设计/ARCHITECTURE.md`
6. `01-总览/TESTING_STRATEGY.md`

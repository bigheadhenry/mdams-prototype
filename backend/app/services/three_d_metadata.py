...
def build_three_d_metadata_layers(
    *,
    ...
    core = {
        ...
        'three_d_object_id': _lookup_value(source, 'three_d_object_id'),
        'representation_type': _lookup_value(source, 'representation_type') or 'derivative',
        'publication_status': _lookup_value(source, 'publication_status') or 'draft',
